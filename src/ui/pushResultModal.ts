...
export class PushResultModal extends Modal {
  ...
  constructor(app: App, report: PushExecutionReport) {
    super(app);
    this.report = report;
  }
  ...
  public onOpen(): void {
    ...
    if (activeResults.length === 0) {
      ...
      emptyEl.setText("No local changes required push. Remote repository is up to date.");
    } else {
  ...
  private renderRow(parent: HTMLElement, res: PushFileResult): void {
