...
[![Version](https://img.shields.io/badge/version-1.0.6-blue.svg)](https://github.com/ankhang0704/github-vault-relay/releases)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

## Current canonical baseline

- Release: `1.0.6` (manifest, package, tag, and `main` agree after release).
- Minimum Obsidian version: `1.11.4`.
- Mobile support: enabled (`isDesktopOnly: false`).
- Automated evidence: 44 Vitest test files and 480 passing tests in the current tree.
